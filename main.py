...
def get_sent_id(sent: TokenList) -> str:
    ...
    if "sent_id" in sent.metadata:
        return sent.metadata["sent_id"]
    else:
        # e.g. "source_sent_id = . . train-s1678"
        return sent.metadata["source_sent_id"].split()[-1]
